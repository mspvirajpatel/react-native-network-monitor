...
export const DebugTrigger = ({
  ...
  useEffect(() => {
    (async () => {
      const saved = await getStorageValue(BTN_STORAGE_KEY, null);
      if (!saved) return;
      const {
        width: sw,
        height: sh
  ...
  const snapToEdge = (x, y, anim) => {
    ...
    setStorageValue(BTN_STORAGE_KEY, {
      x: snapX,
      y: clamped.y
    });
  };
  ...
  }, /*#__PURE__*/React.createElement(ErrorBoundary, null, /*#__PURE__*/React.createElement(DebugContext.Provider, {
    value: ctxValue
  ...
  }, t.confirm)))))))))), /*#__PURE__*/React.createElement(Animated.View, {
