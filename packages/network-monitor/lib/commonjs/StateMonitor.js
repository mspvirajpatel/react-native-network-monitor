...
exports.createZustandMonitor = createZustandMonitor;
...
function subscribeToState(config) {
...
function createZustandMonitor(storeOrApi, options) {
  const config = {
    ...DEFAULT_CONFIG,
    ...options
  };
